...
function show(){
	window.open("content.jsp","상품등록", "width=600, height=630,left=450,top=130")
}
</script>
</head>
<body>
<div id="login">
<span style="font-family:arial"><a href="login.jsp" style="color:black; text-decoration: none;">로그인</a></span> | <span style="font-family:arial">회원가입</span>
</div>
